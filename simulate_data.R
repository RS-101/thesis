...
simulate_constant_hazard <- function(
    n = 1000,
    censoring_time = 100,
    mean_01 = 3,
    mean_02 = 10,
  ...
  # parameters
  mean_01 <- 3 # Ill from state 0
  mean_02 <- 10 # Death from state 0
  mean_12 <- 5

  a01 <- function(x) 1 / mean_01
  a02 <- function(x) 1 / mean_02
  a12 <- function(x) 1 / mean_12

  # latent event times
  T01 <- rexp(n, 1 / mean_01)
  T02 <- rexp(n, 1 / mean_02)
  T12 <- rexp(n, 1 / mean_12)
